...
export function useCnDistricts() {
  return ChineseDistricts;
}
export function useCnProvince() {
  return chineseProvince;
}

export function findDistrictsCode(name: string, code: number | string) {
  let result: any = '';
  for (const key in ChineseDistricts[code]) {
    if (ChineseDistricts[code][key] == name) {
      result = key;
    }
  }
  return result;
